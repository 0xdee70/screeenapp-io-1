...
//                       <Button onClick={handleSave} disabled={isRecording || isLoading} className="h-12 font-semibold bg-green-500 hover:bg-green-600 text-white">
...
//                               <Button variant="outline" size="icon" onClick={() => setDeleteId(recording._id)} style={{ fontSize: '0.6em' }}>
...
//                               </AlertDialogHeader>
//                               <AlertDialogFooter>
//                                 <AlertDialogCancel className="text-black hover:text-black">Cancel</AlertDialogCancel> {/* Adjusted the color of the cancel button */}
